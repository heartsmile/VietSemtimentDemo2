package spring.fb.demo.vietsentiment;
...
public class VietSentiData implements Serializable {
	...
	/**
	 * temporary HashMap to store dictionary of VSWN
	 */
	private static HashMap<String, Vector<Double>> temp = new HashMap<String, Vector<Double>>();
